...
<script type="text/javascript">
  function  formatteris(value,rows,index){
	  return value.name;
  }
</script>
...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'tbItemCat',width:100,formatter:formatteris">商品类目名称</th>
            <th data-options="field:'paramData',width:300,formatter:TAOTAO.formatItemParamData">规格(只显示分组名称)</th>
